...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - 홈페이지 관리 -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="https://blackrockdigital.github.io/startbootstrap-sb-admin-2/blank.html#" data-toggle="collapse" data-target="#collapseHomepage" aria-expanded="true" aria-controls="collapseUtilities">
        ...
        <div id="collapseHomepage" class="collapse" aria-labelledby="headingHomepage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">상세 메뉴</h6>
            <a class="collapse-item" href="intranetProgramBoard.jsp">보육프로그램</a>
            <a class="collapse-item" href="intranetAlbumBoard.jsp">앨범</a>
            <a class="collapse-item" href="intranetCommunityBoard.jsp">가정통신문</a>            
          </div>
        </div>
      </li>
